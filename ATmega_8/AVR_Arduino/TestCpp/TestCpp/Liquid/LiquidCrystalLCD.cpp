/*
* LiquidCrystalLCD.cpp
*
* Created: 7/26/2018 4:18:37 PM
*  Author: taivb
*/
...
size_t LiquidCrystal_I2C::print(unsigned char b, int base)
{
	return print((unsigned long) b, base);
}

size_t LiquidCrystal_I2C::print(int n, int base)
{
	return print((long) n, base);
}

size_t LiquidCrystal_I2C::print(unsigned int n, int base)
{
	return print((unsigned long) n, base);
}

size_t LiquidCrystal_I2C::print(long n, int base)
{
	if (base == 0) {
		return write(n);
		} else if (base == 10) {
...
size_t LiquidCrystal_I2C::print(unsigned long n, int base)
{
...
// Private Methods /////////////////////////////////////////////////////////////
size_t LiquidCrystal_I2C::printNumber(unsigned long n, uint8_t base)
{
...
size_t LiquidCrystal_I2C::printFloat(double number, uint8_t digits)
{
	size_t n = 0;
